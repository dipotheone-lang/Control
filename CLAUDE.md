...
**Charter version:** 4.7 — 16-Aug-2026 — decisions D-07 (O-05 closed on Option C, extended mailbox scope, gated on O-07/O-08/O-10), D-08 (interim Outlook COM transport, Graph required before Phase 2), D-09 (continuity CC retained, reviewed 16-Nov-2026), D-10 (CEO flag budget 10/week) and D-11 (encrypted backup to the company tenant); O-01, O-09 and O-11 also closed (Appendix B). Prior: 4.4 — D-05 narrow date-extraction exception to D-01 for the class 2 registers; 4.3 — second-round review findings V1–V15 (`docs/CHARTER-REVIEW-v4.2.md`; traceability in Appendix C)
